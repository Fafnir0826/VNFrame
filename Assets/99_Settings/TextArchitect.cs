...
public class TextArchitect
{
    ...
    public string tragetText { get; private set; } = "";
    public string preText { get; private set; } = "";
    private int preTextLength = 0;
    public string fullTargetText => preText + tragetText;
    ...
    IEnumerator Building()
    {
        ...
        switch (buildMethod)
        {
            ...
            case BuildMethod.typewriter:
                yield return Building_Typewriter();
                break;
    ...
    private IEnumerator Building_Typewriter()
    {

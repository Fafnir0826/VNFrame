...
namespace CHARACTERS
{
    public class CharacterSpriteLayer
    {
        ...
        private bool isFacingLeft = Character.DEFAULT_ORIENTAION_IS_FACING_LEFT;
        ...
        public bool isFlapping => co_flipping != null;
            ...
            while (renderCG.alpha < 1 || oldRenderers.Any(oldCG => oldCG.alpha > 0))
            {
                ...
                for (int i = oldRenderers.Count - 1; i >= 0; i--)
                {
                    ...
                    if (oldCG.alpha <= 0)
                    {
                        ...
                        UnityEngine.Object.Destroy(oldCG.gameObject);
                    }
                }
        ...
        public IEnumerator FaceDirection(bool facingLeft, float speedMultiplier, bool immediate)
        {
